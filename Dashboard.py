...
def getResponse(_query):
    ...
    ai_msg=agent.invoke(
                    {
                        "input": '''Analyse the data and give an elaborate detailed statistical analysis of the data. Evaluate any expression if required. Give insightful inferences by analysing the data. Give your answers in points as well as paragraphs wherever applicable. 
