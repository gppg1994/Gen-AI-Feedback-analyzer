...
def main():
    ...
    if os.path.exists(r"Input Data\Collection.xlsx"):
        ...
        with catg_analysis:
            ...
            catg_wise,trends=st.tabs(["Function wise Feedback Trends","Overall Feedback Trends"])
            with catg_wise:    
            ...
            with trends:    
                with st.container(border=True):
                    ...
                    for c in row1:
                        ...
                        c.plotly_chart(fig,use_container_width=True,key=str(idx))
                        idx+=1
                    for c in row2:
                        c.markdown(category_list[idx])
                        filtered_data=data[(data['month_name']==select_month) & (data['Category']==category_list[idx])]
        ...
        with st_analysis:
    # Display chart
            feedback_trends,trends=st.tabs(["Feedback Trends by Sentiment","Overall Trends"])
            data['count']=1
